...
const DoctorList = () => {
  ...
  const getMatchingSpecialty = (specialization) => {
    const map = {
  ...
  const specialty = getMatchingSpecialty(specialization);
  ...
  return (
    <div className="doctor-list-container">
      ...
      <h1 className="page-title">
        Doctors in {specialization.charAt(0).toUpperCase() + specialization.slice(1)}
      </h1>
            ...
            <li key={doc.id} className="doctor-card">
              ...
              <div className="doctor-details">
                ...
                <div className="mode-buttons">
                  <button
                    onClick={() => handleBooking(doc, 'Offline')}
